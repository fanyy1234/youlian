 ...
 *
 */
public class OrderListFragment extends BaseLazyFragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_usdtorder_list, container, false);
